...
const closeModalDelete = document.querySelector(".modal__close-delete-yes")
...
const addToCartMain = document.querySelector(".home__button")
...
const openDiscover = document.querySelector(".discover_btn")
const discoverInfo = document.querySelector(".discover")
const discoverClose = document.querySelector(".discover__close")

openDiscover.addEventListener("click", (e) => {
    e.preventDefault()
    discoverInfo.classList.add("discover--show")
});

discoverClose.addEventListener("click", (e) => {
    e.preventDefault()
    discoverInfo.classList.remove("discover--show")
});
